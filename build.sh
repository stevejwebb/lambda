...
aws lambda create-function --function-name $lambda --role arn:aws:iam::717061742498:role/lambda_basic_execution --runtime nodejs8.10 --handler index.handler --zip-file fileb://archive.zip 
if [ $? -eq 0 ]; then 
